...
Q_LAUNCH_ITEMS = [
...

    {
        ...
        "group": "Appointments",
        "icon": "🗓️",
        "keywords": ["appointments", "bookings", "schedule", "reschedule", "cancel"],
        "favorite": True,
        "admin_only": False,
        "active": True,
...

    {
        ...
        "icon": "👥",
        "keywords": ["clients", "customers", "people", "client management"],
        "favorite": True,
        "admin_only": False,
        "active": True,
...

    {
        ...
        "group": "Revenue",
        "icon": "💵",
        "keywords": ["income", "revenue", "sales", "money"],
        "favorite": False,
        "admin_only": False,
        "active": True,
...

    {
        ...
        "group": "Expenses",
        "icon": "💸",
        "keywords": ["expenses", "bills", "costs", "spending"],
        "favorite": False,
        "admin_only": False,
        "active": True,
...

    {
        ...
        "group": "Products",
        "icon": "📦",
        "keywords": ["inventory", "products", "stock", "supplies"],
        "favorite": False,
        "admin_only": False,
        "active": True,
...

    {
        ...
        "icon": "📊",
        "keywords": ["reports", "analytics", "summary", "business reports"],
        "favorite": False,
        "admin_only": False,
        "active": True,
...

    {
        ...
        "group": "Financials",
        "icon": "📈",
        "keywords": ["financial reports", "revenue reports", "income reports", "expense reports"],
        "favorite": False,
        "admin_only": False,
        "active": True,
...

    {
        ...
        "group": "Tools",
        "icon": "📷",
        "keywords": ["scan", "scanner", "sku", "barcode", "qr", "inventory"],
        "favorite": False,
        "admin_only": False,
        "active": True,
...

    {
        ...
        "group": "Accounting",
        "icon": "💼",
        "keywords": ["finance", "financials", "accounting", "money", "income", "expenses"],
        "favorite": True,
        "admin_only": False,
        "active": True,
